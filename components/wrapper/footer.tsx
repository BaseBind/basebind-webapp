            ...
            <div className="mt-8 space-y-4 lg:mt-0">
              <div>
                ...
                <p className="mt-4 max-w-lg  ">
                  Everything we design, develop and deliver would not be
                  possible without the help and ongoing support from our
                  partners. If you wish to become our Partner - Contact us!
                </p>
              </div>
              <form
          ...
          <div className="py-8 lg:py-16 lg:pe-16">
            ...
            <div className="mt-8 border-t   pt-8">
              ...
              <p className="mt-8 text-xs  ">
                &copy; 2025. BaseBind LLC. All rights reserved.
              </p>
            </div>
          </div>
        </div>
