...
const ProjectsData = [
  {
    ...
    description: 'Upload books in multiple formats (.txt, .pdf, .epub) with intuitive metadata management and version control.',
  ...
  },
  {
    ...
    description: 'Automated grammar checks, plagiarism detection, and content moderation to ensure quality and compliance.',
  ...
  },
  {
    ...
    description: 'Smart contract-powered payments with automatic royalty splitting and transparent transaction history.',
  ...
  },
  {
    ...
    description: 'Connect with readers through comments, ratings, discussions, and direct author support via tips.',
  ...
  },
  {
    ...
    description: 'Track earnings, engagement metrics, and reader feedback with comprehensive analytics and reporting.',
  ...
  },
  {
    ...
    description: 'Responsive design with offline reading capabilities and API support for third-party integrations.',
    ...
    <div className="flex flex-col justify-center items-center lg:w-[75%]">
      <div className='flex flex-col mb-[3rem]'>
        ...
        <p className="mx-auto max-w-[500px] text-gray-600 dark:text-gray-400 text-center mt-2 ">
          Everything you need to publish, discover, and monetize digital contents on the blockchain
        </p>
      </div>
